...
based on available YAML files for each EFR32 family.
...
CRATE_DOC_FEATURES = {
    "efr32xg1p": ["rt", "efr32xg1p"],
    "efr32xg12p": ["rt", "efr32xg12p"],
    "efr32xg13p": ["rt", "efr32xg13p"],
    "efr32xg14p": ["rt", "efr32xg14p"],
    "efr32xg21": ["rt", "efr32xg21"],
    "efr32xg22": ["rt", "efr32xg22"],
}

CRATE_DOC_TARGETS = {
    "efr32xg1p": "thumbv7em-none-eabihf",
    "efr32xg12p": "thumbv7em-none-eabihf",
    "efr32xg13p": "thumbv7em-none-eabihf",
    "efr32xg14p": "thumbv7em-none-eabihf",
    "efr32xg21": "thumbv8m.main-none-eabi",
    "efr32xg22": "thumbv8m.main-none-eabi",
}
...
name = "{crate}"
version = "{version}"
authors = ["gecko-rs Contributors"]
description = "Device support crates for {family} devices"
repository = "https://github.com/gecko-rs/gecko-rs"
readme = "README.md"
keywords = ["gecko", "efr32", "svd2rust", "no_std", "embedded"]
...
//! [gecko-rs](https://github.com/gecko-rs/gecko-rs)
//!
//! This crate supports all {family} devices; for the complete list please
//! see:
//! [{crate}](https://github.com/gecko-rs/gecko-rs/tree/master/{crate})
...
[main repo]: https://github.com/gecko-rs/gecko-rs
...
def make_device_rows(table, family):
    ...
    device = family
    dt = table[family]
    links = "[RM]({}), [silabs.com]({})".format(dt['rm_url'], dt['url'])
    members = ", ".join(m for m in dt['members'])
    rows.append("| {} | {} |".format(members, links))
    return "\n".join(sorted(rows))
...
def main(devices_path, yes, families):
    ...
    for path in glob.glob(os.path.join(devices_path, "*.yaml")):
        ...
        family = re.match(r'efr32xg[0-9]+p?', yamlfile)[0]
